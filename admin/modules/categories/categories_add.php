...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($validator->passes()) {
        try {
            ...
            if ($categoryId) {
                logActivity('CREATE', "Menambah kategori: {$data['name']}", 'post_categories', $categoryId);
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" 
                                       ...
                                       placeholder="Contoh: Berita, Kegiatan, Pengumuman" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" rows="3" class="form-control"
                                          placeholder="Deskripsi singkat kategori (opsional)"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <small class="text-muted">Kategori aktif akan muncul di pilihan saat membuat post</small>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="small text-muted">
                            <i class="bi bi-info-circle"></i> Kategori digunakan untuk mengelompokkan post berdasarkan topik atau jenis konten.
                        </p>
                        <hr>
                        <p class="small text-muted mb-0">
                            <strong>Tips:</strong><br>
                            • Gunakan nama yang jelas dan deskriptif<br>
                            • Hindari kategori yang terlalu umum atau terlalu spesifik<br>
                            • Maksimal 10-15 kategori utama
                        </p>
                    </div>
                </div>
            </div>
