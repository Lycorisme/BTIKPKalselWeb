...
/**
 * Contact Page
 * Contact form dengan info lengkap dan Google Maps
 */
...
// Page variables
 ...
 $pageTitle = 'Hubungi Kami - ' . getSetting('site_name');
 $pageDescription = 'Hubungi kami untuk informasi, pertanyaan, atau kerjasama';
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <?php if ($whatsapp = getSetting('contact_whatsapp')): ?>
                ...
                <!-- Social Media - MODERN ANIMATED DESIGN -->
                <?php
                $social_platforms = [
                    'facebook' => [
                            ...
                            <div class="relative flex items-center justify-between p-3 border border-gray-200 rounded-lg group-hover:border-transparent group-hover:shadow-md transition">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-500"><?= $social['username'] ?></div>
                                    </div>
                                </div>
