...
<div class="bg-gray-100 py-4">
    <div class="container mx-auto px-4">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
            <span class="text-gray-600">Tag: <?= htmlspecialchars($tag['name']) ?></span>
        </nav>
    </div>
</div>
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-8" data-aos="fade-up">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            <div class="text-sm text-gray-500 mb-1">TAG</div>
                ...
                <div class="bg-white rounded-lg shadow-md p-12 text-center">
                    ...
                    <p class="text-gray-500 mb-6">Tag ini belum memiliki artikel</p>
